            ...
            <div className="flex flex-col lg:flex-row justify-between gap-8  mt-12 md:mt-28">
                ...
                <div data-aos="fade-up" data-aos-delay="200" className="w-full h-[18rem] blogfirst flex flex-col justify-center items-center">
                    ...
                    <div className="text-center mt-6">
                        <Link to='/blogs'><button className="capitalize h-14 lg:w-[20vw] bg-[#3B823E] px-5 text-white font-semibold md:text-xl rounded-lg mt-4 hover:bg-white hover:text-black hover:border-2 hover:border-green-800">Read Blog</button></Link>
                    </div>
                </div>
