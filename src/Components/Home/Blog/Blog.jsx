    ...
    return (
        <div className="mt-28 mx-[10%]">
            ...
            <div className="flex flex-col lg:flex-row justify-between gap-8 mt-28">
                ...
                <div className="w-full h-[18rem] blogfirst flex flex-col justify-center items-center">
                ...
                <div className="w-full h-[18rem] blogsecond flex flex-col justify-center items-center">
