    ...
    return (
        <div className="mt-28 mx-[10%]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 items-center">
                <img className="gallery cursor-grabbing" src={cel1} alt="" />
                <img className="gallery cursor-grabbing" src={cel2} alt="" />
                <img className="gallery cursor-grabbing" src={cel3} alt="" />
                <img className="gallery cursor-grabbing" src={cel4} alt="" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center">
                <img className="gallery cursor-grabbing" src={cel5} alt="" />
                <img className="gallery cursor-grabbing" src={cel6} alt="" />
                <img className="gallery cursor-grabbing" src={cel7} alt="" />
