    ...
    return (
        <div className="mt-28 mx-[10%]">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 items-center">
                <img data-aos="fade-up" data-aos-delay="200" className="circle" src={cel1} alt="" />
                <img data-aos="fade-up" data-aos-delay="200" className="circle" src={cel2} alt="" />
                <img data-aos="fade-up" data-aos-delay="200" className="circle" src={cel3} alt="" />
                <img data-aos="fade-up" data-aos-delay="200" className="circle" src={cel4} alt="" />
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 items-center">
                <img data-aos="fade-down" data-aos-delay="200" className="circle" src={cel5} alt="" />
                <img data-aos="fade-down" data-aos-delay="200" className="circle" src={cel6} alt="" />
                <img data-aos="fade-down" data-aos-delay="200" className="circle" src={cel7} alt="" />
